...
//				printMethods();
				...
				if(!entrypoints.iterator().hasNext()){
					// a aplica��o n�o possui main, tentando pegar entrypoint dos testes
//					O WALA n�o suporta o Junit 4, ficando invi�vel pegar o entrypoint dos testes visto que as anota��es s�o necess�rias
...
//					entrypoints = JUnitEntryPoints.make(classHierarchy);
				...
				// imprime todas as ramifica��es a partir dos entries points at� um cgnode primordial.
